...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface CampusCredNFTInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "MINTER_ROLE" | "approve" | "balanceOf" | "getApproved" | "getRoleAdmin" | "grantRole" | "hasRole" | "isApprovedForAll" | "isRevoked" | "mint" | "name" | "ownerOf" | "renounceRole" | "revoke" | "revokeRole" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "CredentialMinted" | "CredentialRevoked" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "Transfer"): EventFragment;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
    ...
    export namespace CredentialMintedEvent {
      export type InputTuple = [tokenId: BigNumberish, recipient: AddressLike, uri: string];
      export type OutputTuple = [tokenId: bigint, recipient: string, uri: string];
      export interface OutputObject {tokenId: bigint, recipient: string, uri: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface CampusCredNFT extends BaseContract {
    
    connect(runner?: ContractRunner | null): CampusCredNFT;
    waitForDeployment(): Promise<this>;

    interface: CampusCredNFTInterface;
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'CredentialMinted(uint256,address,string)': TypedContractEvent<CredentialMintedEvent.InputTuple, CredentialMintedEvent.OutputTuple, CredentialMintedEvent.OutputObject>;
      ...
      'CredentialRevoked(uint256)': TypedContractEvent<CredentialRevokedEvent.InputTuple, CredentialRevokedEvent.OutputTuple, CredentialRevokedEvent.OutputObject>;
